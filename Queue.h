...
private:
    ...
    */
    ...
    /*
     * Free all pointers in an array of pointers.
     *
    ...
    /*
     * copying content of array of pointers considering badAlloc exception.
     *
     * @param dest - the array to copy to.
     * @param source - the array to copy from.
     * @param size - the number of items needed to be copied.
     */
...
public:
    /*
     * Operator overloading needed for iterating the queue class objects
    */
    DataType &operator*();
    Iterator &operator++();
...
/*
 * changes every element in a queue according to a given rule.
 *
